...
<body>
    ...
    <ul class="w3-navbar w3-left-align w3-light-grey w3-center w3-top w3-large">
        <li class="w3-left" style="width: 20% !important"><a href="javascript:void(0)" class="w3-text-teal">Home</a></li>
        <li class="w3-left" style="width: 20% !important"><a href="reportes.aspx">Reporte 1</a></li>
        <li class="w3-left" style="width: 20% !important"><a href="reporte2.aspx">Reporte 2</a></li>
        <li class="w3-left" style="width: 20% !important"><a href="reporte3.aspx">Reporte 3</a></li>
        <li class="w3-left" style="width: 20% !important"><a href="javascript:void(0)">Contact</a></li>
    </ul>
            ...
            <form id="form1" runat="server">
                <div>
                    <asp:Panel ID="Panel1" runat="server" Style="z-index: 1; left: 38px; top: 162px; position: absolute; height: auto; width: auto;">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Style="z-index: 6; left: 399px; top: 232px; position: absolute; width: auto;">
                        </asp:GridView>
